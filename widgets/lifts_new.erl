...
%% insert(Dir, Nfloor, Pos, Stop) -> Stop'
%%   Somebody on Floor N floor has pushed Dir button
%%   Dir = up | down Nfloor = 1..6
%%   Pos = the absolute position of the lift (0..100)
%%   Stop is a list where we are going to stop at
%%   insert Floor into Stop
